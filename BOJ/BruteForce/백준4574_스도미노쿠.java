...
public class Main{
	...
	static boolean[][] c = new boolean[10][10]; //가로
	static boolean[][] c2 = new boolean[10][10]; //세로
	static boolean[][] c3 = new boolean[10][10]; //사각형
	static boolean[][] domino = new boolean [10][10]; //도미노 사용체크
